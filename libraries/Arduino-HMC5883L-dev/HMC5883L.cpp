...
bool HMC5883L::begin()
{
    Serial.println("Entering HMC5883L::begin");

    Wire.begin();
    Serial.println("Wire.begin() executed");

    //Bypass Mode
    Wire.beginTransmission(0x68);
    Serial.println("Wire.beginTransmission(0x68) executed");
    Wire.write(0x37);
    Serial.println("Wire.write(0x37) executed");
    Wire.write(0x02);
    Serial.println("Wire.write(0x02) executed");
    Wire.endTransmission();
    Serial.println("Wire.endTransmission() executed");

    Wire.beginTransmission(0x68);
    Serial.println("Wire.beginTransmission(0x68) executed");
    Wire.write(0x6A);
    Serial.println("Wire.write(0x6A) executed");
    Wire.write(0x00);
    Serial.println("Wire.write(0x00) executed");
    Wire.endTransmission();
    Serial.println("Wire.endTransmission() executed");
    ...
    Serial.println("Wire.beginTransmission(0x68) executed");
    Wire.write(0x6B);
    Serial.println("Wire.write(0x6B) executed");
    Wire.write(0x00);
    Serial.println("Wire.write(0x00) executed");
    Wire.endTransmission();
    Serial.println("Wire.endTransmission() executed");
    ...
    {
        Serial.println("fastRegister8 check failed");
	    return false;
    }

    Serial.println("fastRegister8 check passed");
    setRange(HMC5883L_RANGE_1_3GA);
    Serial.println("setRange(HMC5883L_RANGE_1_3GA) executed");
    setMeasurementMode(HMC5883L_CONTINOUS);
    Serial.println("setMeasurementMode(HMC5883L_CONTINOUS) executed");
    setDataRate(HMC5883L_DATARATE_15HZ);
    Serial.println("setDataRate(HMC5883L_DATARATE_15HZ) executed");
    setSamples(HMC5883L_SAMPLES_1);
    Serial.println("setSamples(HMC5883L_SAMPLES_1) executed");

    mgPerDigit = 0.92f;
    Serial.println("mgPerDigit = 0.92f executed");

    Serial.println("Exiting HMC5883L::begin with return true");
    return true;
}
...
{
    Serial.println("Entering setMeasurementMode()");
    uint8_t value;

    value = readRegister8(HMC5883L_REG_MODE);
    Serial.println("Value after readRegister8: " + String(value, BIN));
    value &= 0b11111100;
    Serial.println("Value after bitwise AND: " + String(value, BIN));
    value |= mode;
    Serial.println("Value after bitwise OR: " + String(value, BIN));

    writeRegister8(HMC5883L_REG_MODE, value);
    Serial.println("Exiting setMeasurementMode()");
}
